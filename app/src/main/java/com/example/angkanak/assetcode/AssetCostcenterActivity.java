...
public class AssetCostcenterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arlCost.add("2202:ฝ่ายบริหารคลัง&สารสนเทศการผลิต");
        arlCost.add("2203:ฝ่ายบริหารคลัง&สารสนเทศการผลิต");
        arlCost.add("2204:ฝ่ายบริหารคลัง&สารสนเทศการผลิต");
        arlCost.add("2205:ฝ่ายส่งออก");
        arlCost.add("3001:ฝ่ายฟาร์มกุ้ง");
        ...
        arlCost.add("5001:ฝ่ายผลิต");
        arlCost.add("5131:ฝ่ายผลิต");
        arlCost.add("5140:ฝ่ายประกันคุณภาพ");
        arlCost.add("5311:ฝ่ายผลิต");
        arlCost.add("5411:ฝ่ายผลิต");
        arlCost.add("5420:ฝ่ายผลิต");
        arlCost.add("5425:ฝ่ายผลิต");
        arlCost.add("5700:ฝ่ายบริหารทรัพยากรบุคคล");
        arlCost.add("5812:ฝ่ายผลิต");
        arlCost.add("5901:ฝ่ายวิศวกรรม");
        arlCost.add("5951:ฝ่ายวิศวกรรม");
        arlCost.add("5952:ฝ่ายวิศวกรรม");
        arlCost.add("5966:ฝ่ายวิศวกรรม");
        arlCost.add("6100:ฝ่ายวิจัยและพัฒนา");
        arlCost.add("6200:ฝ่ายประกันคุณภาพ");
        arlCost.add("6300:ฝ่ายบริหารทรัพยากรบุคคล");
        arlCost.add("6400:ฝ่ายประกันคุณภาพ");
