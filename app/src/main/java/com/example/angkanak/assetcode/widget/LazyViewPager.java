package com.example.angkanak.assetcode.widget;
...
public class LazyViewPager extends ViewGroup {
    ...
    private static final int DEFAULT_OFFSCREEN_PAGES = 0;//Default loading page,ViewPager is 1,So it will load two Fragment
