...
//        });
    ...
    public class btnLockOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            String strPWD = EtAccessPwd_Lock.getText().toString().trim();// Access password
            ...
            if(cb_filter_lock.isChecked()){
                ...
                if(filterData==null || filterData.isEmpty()){
                    UIHelper.ToastMessage(mContext, "Filtered data cannot be empty.!");
                    return;
                }
                if(etPtr_filter_lock.getText().toString()==null || etPtr_filter_lock.getText().toString().isEmpty()){
                    UIHelper.ToastMessage(mContext, "Filter start address cannot be empty.");
                    return;
                }
