...
public class Report_CostcenterActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_report__costcenter);
        ...
        final ListView listView = (ListView)findViewById(R.id.lvCostcenter);
        listView.setAdapter(adapter);

        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent showPage = new Intent(Report_CostcenterActivity.this,Report_SectionActivity.class);
                String  itemValue    = (String)listView.getItemAtPosition(i);
                showPage.putExtra("Report_CostDepart",""+itemValue+"");
