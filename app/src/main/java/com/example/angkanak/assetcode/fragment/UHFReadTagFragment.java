...
public class UHFReadTagFragment extends KeyDwonFragment {
    ...
    Button BtInventory;
    ListView LvTags;
    private Button btnFilter;//filter
                    ...
                    btSet.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (etPtr.getText().toString() == null || etPtr.getText().toString().isEmpty()) {
                                UIHelper.ToastMessage(mContext, "Start address cannot be empty.");
                                return;
                            }
...
//									mContext.playSound(2);
    ...
    public class BtImportClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (BtInventory.getText().equals(
                ...
                if (re) {
                    UIHelper.ToastMessage(mContext, "Export successful.");
            ...
            {
                UIHelper.ToastMessage(mContext, "Please stop scanning and then export.");
            }
        }
    ...
    private void readTag() {
        if (BtInventory.getText().equals(
                mContext.getString(R.string.btInventory)))// Identification tag
        {
...
//					mContext.playSound(2);
                ...
                break;
                case 1:// Single label cycle  .startInventoryTag((byte) 0, (byte) 0))
                {
